 ...
 * @author Admin
 */
public class RandomRowEffectTest {
     static Game aGame;
     
        public RandomRowEffectTest() {
        }
         ...
         */
        @Test
        public void testRandomRowEffectNormalGame() {
            ...
            aGame.getBoard().getTileIJ(height - 3, 0).setEffect(new RandomRowEffect());
            ...
            assertTrue("Doit être d'effet randomRow", aGame.getBoard().getTileIJ(height - 3, 0).getEffect() instanceof RandomRowEffect);
            assertTrue(aGame.getCurrentPlayer().getId() != id_player);
            assertEquals(nb_tokens_before + 1, nb_tokens_after);
        }
     
        /**
         * Test de RandomRowEffect sur grille vide 
         * Vérification de l'état de la
         * tuile après application de l'effet 
         * Résultats attendus : la grille doit compter 10 pions
         */
        @Test
        public void testRandomRowEffectEmptyGame() {
     
            // Effet fixé sur une case 
            int height = aGame.getBoard().getHeight();
            aGame.getBoard().getTileIJ(height - 1, 0).setEffect(new RandomRowEffect());
            ...
            assertTrue("Doit être d'effet randomRow", aGame.getBoard().getTileIJ(height - 1, 0).getEffect() instanceof RandomRowEffect);
            assertTrue(aGame.getCurrentPlayer().getId() != id_player);
     
        }
     
        /**
         * Test de RandomRowEffect sur grille pré-remplie 
         ...
         */
        @Test
        public void testRandomRowEffectFilledGame() {
